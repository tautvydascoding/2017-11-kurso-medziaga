...
$clientEmail = $_GET['pastas'];
$clientTitle = $_GET['data'];
$clientQuestion = $_GET['numeris'];
...
try {
    ...
    $mail->Username = 'chirvas@gmail.com';           // SMTP username
    $mail->Password = 'ltarnas1994';                      // SMTP password
   ...
   header('Location: ' .'../kontaktai.php', true);
}
